...
Trained using **14-15 diverse images per class** taken from **diffrent angles, prespictive and environmental conditions** to ensure high accuracy and robustness.
